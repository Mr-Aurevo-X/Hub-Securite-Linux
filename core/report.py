...
<title>Rapport Hub Sécurité</title>
<style>
...
<p><small>Hub Sécurité — © 2026 Mr-Aurevo-X — GPL-3.0-or-later</small></p>
</body></html>
"""
...
def default_report_path() -> Path:
    stamp = time.strftime("%Y%m%d-%H%M%S")
    return Path.home() / "Documents" / f"hub-securite-rapport-{stamp}.html"
