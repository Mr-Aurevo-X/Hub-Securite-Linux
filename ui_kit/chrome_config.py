...
LEGAL_RGPD = _read_legal_file(
    "rgpd.md",
    "Données 100 % locales — ~/.config/Mr-Aurevo-X/hubs/securite/",
)
...
LEGAL_LICENSES = _read_legal_file(
    "licenses.md",
    "Hub Sécurité — GNU GPL-3.0-or-later © 2026 Mr-Aurevo-X.",
)
