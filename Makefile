...
help:
	...
	@echo "  make flatpak  -> dist/org.mraurevox.HubSecurite-$(VERSION).flatpak + asset public"
...
dist:
	...
	tar -czf $(TARBALL) \
		...
		./Hub-Securite.desktop ./Makefile ./MANIFEST \
...
clean:
	...
	rm -f $(DIST_DIR)/hub-securite_*.deb
	rm -f $(DIST_DIR)/org.mraurevox.HubSecurite-*.flatpak
	rm -f $(DIST_DIR)/org.mraurevox.HubSecurite.flatpak
