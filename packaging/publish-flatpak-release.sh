#!/usr/bin/env bash
# Publie le .flatpak Gest sur Mr-Aurevo-X/Hub-Securite (tag vX.Y.Z).
set -euo pipefail

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
PUBLIC_REPO="Mr-Aurevo-X/Hub-Securite-Linux"
