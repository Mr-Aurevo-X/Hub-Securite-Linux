...
class MainWindow(Adw.ApplicationWindow):
    ...
    def _do_apply_updates(self) -> None:
        ...
        def work() -> dict[str, Any]:
            return backup.create_snapshot("Hub Sécurité: avant MAJ paquets")
    ...
    def _export_logs(self) -> None:
        ...
        default = Path.home() / "Documents" / f"hub-securite-journal-{stamp}.txt"
    ...
    def _export_connections(self) -> None:
        ...
        if not items:
            ...
            return
        stamp = time.strftime("%Y%m%d-%H%M%S")
        path = Path.home() / "Documents" / f"hub-securite-connexions-{stamp}.csv"
