...
"""Hub Sécurité — point d'entrée GTK4 / Libadwaita."""
...
def _launch_log_path() -> Path:
    ...
    return Path(xdg) / "hub-securite" / "launch.log"
...
class HubSecuriteApp(Adw.Application):
    def __init__(self) -> None:
        super().__init__(
            application_id="org.mraurevox.HubSecurite",
    ...
    def do_activate(self) -> None:  # noqa: N802 - GObject override
        ...
        apply_theme(config_app_id="hub-securite")
